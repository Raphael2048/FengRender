...
namespace feng
{
    ...
    public:
        ...
        size_t GetIndex() { return srv_heap_index_; }
    ...
    {
        int base_color_index_;
        int normal_index_;
        int roughness_index_;
        int metallic_index_;
    };
    ...
    public:
        ...
        MaterialConstantBuffer tex_indices_;
        size_t buffer_index_;

        static std::vector<std::shared_ptr<StaticMaterial>> materials_vector_;
    private:
